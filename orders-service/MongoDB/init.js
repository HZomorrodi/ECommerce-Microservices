...
// Switch to your database (no 'var' keyword needed)
db = db.getSiblingDB("OrdersDatabase");

// Drop existing collection if needed (optional - removes previous data)
// db.orders.drop();

// Insert orders
var result = db.orders.insertMany(orders);

// Print confirmation
print("========================================");
print("SUCCESS: Inserted " + result.insertedIds.length + " orders into 'OrdersDatabase.orders'");
print("========================================");